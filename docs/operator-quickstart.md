# Operator Quickstart — Community Recreational and Sports Goods Rental Operations

Shortest path from clone to a verified local dry-run for **ISIC 7721** (`cloud-itonami-isic-7721`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7721.git
cd cloud-itonami-isic-7721
```
...
- Blueprint governor key: `recreational-rental-governor`
- Likely source path: `src/**/recreational-rental-governor.cljc`
